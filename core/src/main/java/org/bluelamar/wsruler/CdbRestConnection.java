 ...
 *
 */
public class CdbRestConnection implements RestConnection {
	
	private static final Logger LOG = LoggerFactory.getLogger(CdbRestConnection.class);

	String svcName;
	String url;
	private ConnStatus connStatus = RestConnection.ConnStatus.Unconnected;
	private Client client;
	private WebTarget baseTarget;
	private Map<String, String> cookieMap = new HashMap<>(); // set automatically from server responses
	
	public CdbRestConnection() {
	}
	 ...
	 */
	public CdbRestConnection(String url) {
        setUrl(url);
	}
	 ...
	 */
	public CdbRestConnection(String svcName, String url) {
	...
	public RestConnection clone() {
		...
		return new CdbRestConnection(svcName, url);
	}
